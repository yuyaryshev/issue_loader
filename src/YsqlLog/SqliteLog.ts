...
export const defaultLogSettings: LogSettings = {
    table: "log",
    durationLimit: makeMomentInterval("30 d"),
...
export class SqliteLog<T extends SqliteLogItem> {
    ...
    constructor(
        ...
        const insertStmt = db.prepare(
            `insert into ${this.tableName}(id, ts, cpl, message, severity, ${columns.join(
                ","
            ...
            if (settings.countLimit) {
                ...
                deleteOldStmt.run({
                    ...
                    limitingId: settings.countLimit
                        ...
                        : undefined,
                    limitingTs: settings.durationLimit ? moment().subtract(settings.durationLimit) : undefined,
